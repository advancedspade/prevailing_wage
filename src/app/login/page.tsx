    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#e8e8e8' }}>
      <div className="max-w-md w-full space-y-8 p-10 bg-white border border-gray-200">
        ...
        <div className="mt-8 space-y-6">
          <button
            type="button"
            onClick={() => signIn('google', { callbackUrl: '/admin/periods' })}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 text-sm font-medium text-white transition-colors hover:opacity-90"
          ...
          <p className="text-center text-sm" style={{ color: '#6b7280' }}>
            Admin access only. Sign in with your Google account.
          </p>
        </div>
      </div>
    </div>
